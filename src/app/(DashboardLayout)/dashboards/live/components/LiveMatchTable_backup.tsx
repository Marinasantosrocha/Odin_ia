...
const LiveMatchTable: React.FC<LiveMatchTableProps> = ({ 
  ...
  const getBestOdds = useCallback((fixtureId: number) => {
    ...
    const bestOdds = { home: null, draw: null, away: null };
          ...
          bookmaker.bets.forEach((bet: any) => {
            if (bet.name === 'Match Winner' && bet.values) {
              bet.values.forEach((value: any) => {
                ...
                if (value.value === 'Home' && (!bestOdds.home || odd > bestOdds.home)) {
                  bestOdds.home = odd;
                }
                if (value.value === 'Draw' && (!bestOdds.draw || odd > bestOdds.draw)) {
                  bestOdds.draw = odd;
                }
                if (value.value === 'Away' && (!bestOdds.away || odd > bestOdds.away)) {
                  bestOdds.away = odd;
                }
              });
            }
                    ...
                    <>
                      ...
                      <TableCell align="center">
                        <Typography 
                          ...
                          fontWeight="medium"
                          sx={{ 
                            color: bestOdds?.home ? 'primary.main' : 'text.secondary',
                            fontSize: '0.875rem'
                          }}
                        >
                          {bestOdds?.home ? bestOdds.home.toFixed(2) : '-'}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell align="center">
                        <Typography 
                          ...
                          fontWeight="medium"
                          sx={{ 
                            color: bestOdds?.draw ? 'warning.main' : 'text.secondary',
                            fontSize: '0.875rem'
                          }}
                        >
                          {bestOdds?.draw ? bestOdds.draw.toFixed(2) : '-'}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell align="center">
                        <Typography 
                          ...
                          fontWeight="medium"
                          sx={{ 
                            color: bestOdds?.away ? 'success.main' : 'text.secondary',
                            fontSize: '0.875rem'
                          }}
                        >
                          {bestOdds?.away ? bestOdds.away.toFixed(2) : '-'}
                        </Typography>
                      </TableCell>
                    </>
                  );
