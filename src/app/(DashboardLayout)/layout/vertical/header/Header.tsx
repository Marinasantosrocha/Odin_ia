...
const Header = () => {
  const { isSidebarHover, isCollapse, setIsCollapse, setIsSidebarHover, isMobileSidebar, setIsMobileSidebar } = useContext(CustomizerContext);
        ...
        <ToolbarStyled>
          ...
          {lgUp ? (
            ...
            <IconButton
              ...
              onClick={
                lgUp
                  ? () => setIsSidebarHover(!isSidebarHover) // Toggle sidebar for desktop
                  : () => setIsMobileSidebar(!isMobileSidebar) // Toggle mobile sidebar
              }
            >
