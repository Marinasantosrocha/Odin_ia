                ...
                <Grid
                    ...
                    <BlankCard>
                        <CardContent sx={{ p: '32px' }}>
                            ...
                            <Typography fontSize="12px" mb={4}>{license.typeText}</Typography>
                            <Divider />
                            <Stack mt={4} direction="row" gap="8px" alignItems="end">
                                <Typography variant='h4' fontSize="40px" color='primary.main' fontWeight={600}>${license.price}</Typography>
                                <Typography variant='body2' fontSize="14px" whiteSpace="nowrap">/ one time pay</Typography>
                            </Stack>
                            <Stack my={4} gap="12px">
                            ...
                            {license.isPopular ?
                                ...
                                :
                                <Button fullWidth variant="outlined" color='secondary' size="large">Purchase Now</Button>
                            }
                        </CardContent>
                    </BlankCard>
                </Grid>
